  ...
  return (
    ...
    >
      ...
      >
        ...
        {submenu && (
          <Icons
            className="fill-white transition-transform group-aria-[hidden=false]:rotate-180 group-data-[show-submenu=true]:rotate-180 lg:group-data-[show-submenu=true]:rotate-0"
            icon="chevron"
          />
        )}
      </NavLink>
...
export default function Menu() {
  ...
  return (
    <div
      className={`${classes} lg:-px-0 fixed inset-0 z-30 flex-col items-center justify-center bg-blue/50 px-5 pt-20 backdrop-blur-md transition-all lg:visible lg:relative lg:block lg:bg-transparent lg:pt-0 lg:opacity-100 lg:backdrop-filter-none`}
    >
