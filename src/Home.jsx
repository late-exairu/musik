...
export default function Home() {
  return (
    <section className="h-screen flex justify-center items-center bg-black text-white bg-cover bg-center bg-[url('./src/assets/hero-bg.png')]">
      ...
      <div className="container max-w-sm relative z-10 text-center sm:max-w-[560px] md:max-w-[740px] lg:max-w-[980px]">
        ...
        <p className="text-lg md:text-xl lg:text-2xl leading-lg">
          Get ready to rock out at the biggest music festival of the year! With
          an incredible lineup of top artists and an amazing atmosphere, this
          festival is the place to be for music lovers everywhere.
        </p>
